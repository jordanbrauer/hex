...
// renderRecordTable draws a bordered table with headers via
// lipgloss/table. Style is deliberately quiet — subtle border, bold
// headers — so it doesn't fight the surrounding REPL scrollback.
