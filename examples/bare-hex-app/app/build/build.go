...
//
//	go build -ldflags "-X github.com/jordanbrauer/hex/examples/bare-hex-app/app/build.version=v1.0.0 \
//	                   -X github.com/jordanbrauer/hex/examples/bare-hex-app/app/build.commit=$(git rev-parse HEAD) \
//	                   -X github.com/jordanbrauer/hex/examples/bare-hex-app/app/build.date=$(date -u +%Y-%m-%dT%H:%M:%SZ)"
package build
