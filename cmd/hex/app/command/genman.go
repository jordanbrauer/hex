...
// hex.1 from the cobra tree and hex.3 from the Lua Teal stubs). The
// hand-authored pages (hex.5, hex.7) are not touched. `just man`
// runs this and then renders every docs/man/*.md to roff with pandoc.
